...
export const Ruler = () => {
	...
	return (
		<div
			...
			className="mt-32 h-6 border-b border-gray-300 flex items-end relative select-none bg-black print:hidden"
		>
						...
						{markers.map((marker) => {
							...
							return (
								<div key={marker} className="absolute bottom-0" style={{ left: `${position}px` }}>
									{marker % 10 === 0 && (
										<>
											<div className="absolute bottom-0 w-[1px] h-2 bg-neutral-500 transform translate-x-1" />
